...
type BackendTargetGenerator interface {
	Generate(registry *jsonschema.Registry, entrypointMessage pgs.Message, fileOptions *proto.FileOptions) jsonschema.Draft
}
...
func (g *MultiDraftGenerator) Generate(registry *jsonschema.Registry, entrypointMessage pgs.Message, fileOptions *proto.FileOptions) jsonschema.Draft {
