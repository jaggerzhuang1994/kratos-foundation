...
import (
	...
	"github.com/jaggerzhuang1994/kratos-foundation/cmd/protoc-gen-jsonschema/pkg/utils"
...
func GetPluginOptions(params pgs.Parameters) *PluginOptions {
	...
	options.Merge = params.StrDefault("merge", "")
	...
	options.MandatoryNullable, _ = params.BoolDefault("mandatory_nullable", true)
